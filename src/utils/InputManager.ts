...
export class InputManager {
  ...
  private handleKeyPress(_ch: any, key: any): void {
    ...
    switch(keyName) {
      case 't': return this.handlers.onAction('toggleLineOfSight');
      case 'i': return this.handlers.onAction('inventory');
      case 'o': return this.handlers.onAction('options');
      case 'q': return this.handlers.onAction('quit');
    }
